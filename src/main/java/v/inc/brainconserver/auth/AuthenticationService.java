...
import v.inc.brainconserver.Token.TokenRepository;
import v.inc.brainconserver.config.JwtService;
import v.inc.brainconserver.domain.User;
import v.inc.brainconserver.repository.UserRepository;
import v.inc.brainconserver.Token.Token;
import v.inc.brainconserver.Token.TokenType;
...
public class AuthenticationService {
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      var user = this.repository.getUserByEmail(userEmail)
              .orElseThrow();
